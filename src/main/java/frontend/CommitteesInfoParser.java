...
public class CommitteesInfoParser {
	...
	/*
	 * retrieves all files in folder and passes the file-name to parseFile
	 * function
	 * 
	 */
	...
	/*
	 * runs committee parse taking filepath of the folder containing dblp data
	 * for author committee details
	 */
	...
	public static void main(String argp[]) {
		...
		/*
		 * ob.readFilesInDirectoryAndParse(
		 * "C:\\Users\\MOHIT\\Documents\\MSD\\committees\\committees\\");
