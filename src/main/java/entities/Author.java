...
/**
 * This class represents an Author of research paper(s) in the database
 */
public class Author extends Person {
	...
	private String note;
	// The list of research papers - both journal articles and conference
	// articles
	...
	/**
	 * @param numberOfResearchPapers
	 *            the numberOfResearchPapers to set
	 */
	...
	public String toString() {
		...
		builder.append("Author").append(", committeeMemberInfo=").append(committeeMemberInfo)
				.append(", numberOfResearchPapers=").append(numberOfResearchPapers).append(", inProceedings=")
				.append(inProceedings).append(", articles=").append(articles).append(", paperKeys=").append(paperKeys)
				.append("]");
